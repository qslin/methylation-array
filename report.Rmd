...
The unsupervised hierarchical clustering was done using the top 10k probes with the highest Median Absolute Deviation (MAD). NA values were colored black. Probes (rows) were ordered by MAD values.
